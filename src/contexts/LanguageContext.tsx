...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    // Order Form
    "orderForm.title": "Create Song Order",
    "orderForm.subtitle": "Fill in the details to order your personalized song",
    "orderForm.selectSinger": "Select Singer",
    "orderForm.chooseSinger": "Choose a singer...",
    "orderForm.selectCategory": "Song Category",
    "orderForm.chooseCategory": "Choose a category...",
    "orderForm.recipientName": "Recipient Name",
    "orderForm.recipientPlaceholder": "Enter the name of the person receiving the song",
    "orderForm.recipientHint": "This name will be mentioned in the song",
    "orderForm.customMessage": "Custom Message (Optional)",
    "orderForm.messagePlaceholder": "Add any special requests, lyrics ideas, or details about the occasion...",
    "orderForm.priceStarting": "Price starting",
    "orderForm.submit": "Submit Order",
    "orderForm.submitting": "Submitting...",
    "orderForm.error": "Error",
    "orderForm.fillRequired": "Please fill in all required fields",
    "orderForm.success": "Order Submitted!",
    "orderForm.successDesc": "Your order has been submitted successfully. We'll notify you when the singer accepts.",
    "orderForm.whatHappens": "What happens next?",
    "orderForm.step1": "The singer will review your order request",
    "orderForm.step2": "You'll receive a confirmation and price quote",
    "orderForm.step3": "After payment, the singer starts creating your song",
    "orderForm.step4": "You'll receive your personalized song within 3-7 days",
  ...
  ar: {
    ...
    // Order Form
    "orderForm.title": "إنشاء طلب أغنية",
    "orderForm.subtitle": "أدخل التفاصيل لطلب أغنيتك المخصصة",
    "orderForm.selectSinger": "اختر المطرب",
    "orderForm.chooseSinger": "اختر مطرباً...",
    "orderForm.selectCategory": "تصنيف الأغنية",
    "orderForm.chooseCategory": "اختر تصنيفاً...",
    "orderForm.recipientName": "اسم المهدى له",
    "orderForm.recipientPlaceholder": "أدخل اسم الشخص الذي ستُهدى له الأغنية",
    "orderForm.recipientHint": "سيُذكر هذا الاسم في الأغنية",
    "orderForm.customMessage": "رسالة مخصصة (اختياري)",
    "orderForm.messagePlaceholder": "أضف أي طلبات خاصة أو أفكار للكلمات أو تفاصيل عن المناسبة...",
    "orderForm.priceStarting": "السعر يبدأ من",
    "orderForm.submit": "إرسال الطلب",
    "orderForm.submitting": "جاري الإرسال...",
    "orderForm.error": "خطأ",
    "orderForm.fillRequired": "يرجى ملء جميع الحقول المطلوبة",
    "orderForm.success": "تم إرسال الطلب!",
    "orderForm.successDesc": "تم إرسال طلبك بنجاح. سنعلمك عندما يقبل المطرب.",
    "orderForm.whatHappens": "ماذا يحدث بعد ذلك؟",
    "orderForm.step1": "سيراجع المطرب طلبك",
    "orderForm.step2": "ستتلقى تأكيداً وعرض سعر",
    "orderForm.step3": "بعد الدفع، يبدأ المطرب بإنشاء أغنيتك",
    "orderForm.step4": "ستتلقى أغنيتك المخصصة خلال 3-7 أيام",
